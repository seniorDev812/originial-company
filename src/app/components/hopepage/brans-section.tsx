...
const brands: Brand[] = [
    ...
    },
    {
        name: "CHEZ LORRAINE",
        description:
            "Chez Lorraine is one of Seen Group’s leading decoration brand, which reflects quality and classiness with its highly different product range.",
    ...
    },
    {
        name: "CHEZALOU",
        description:
            "Chezalou is one of the Turkey’s premier apparel producer owned by Seen Group; established in 2011.",
    ...
    },
    {
        name: "DEFILE PARIS",
        description:
            "Défilé Paris was founded with the aim of providing fashion-conscious customers with access to the latest trends in clothing and accessories.",
            ...
            try {
                ...
                if (swiperRef.current && !swiperInstanceRef.current) {
                    swiperInstanceRef.current = new Swiper(swiperRef.current, {
                        ...
                        on: {
                            init: function () {
                                console.log('Brands Swiper initialized successfully');
                                console.log('Viewport width:', window.innerWidth);
                                console.log('Container width:', swiperRef.current?.offsetWidth);
                            },
                            slideChange: function () {
                                // Handle slide change events if needed
                            },
                            beforeDestroy: function () {
                                console.log('Brands Swiper destroying...');
                            }
                        }
                    });
                }
